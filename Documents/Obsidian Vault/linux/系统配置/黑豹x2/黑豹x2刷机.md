...
```shell
pip install webssh
pm2 start python3 --name wssh -- wssh --address='0.0.0.0' --port=8000
pm2 stop wssh
```
# 试试anything-llm
...
# 切换到了 https://github.com/Veloera/Veloera
```bash
wget https://github.com/Veloera/Veloera/releases/download/v0.2.1/veloera-linux-arm64
```
🖥pm2配置
```js
module.exports = {
...
        {
            name: "new-api",
            script: "/mnt/disk/development/Veloera/veloera-linux-arm64",
            cwd: "/mnt/disk/development/Veloera",
            autorestart: true,
            error_file: "/mnt/disk/development/Veloera/logs/error.log",
            out_file: "/mnt/disk/development/Veloera/logs/out.log",
            env: {
                STREAMING_TIMEOUT: "6000",
                REDIS_CONN_STRING: "redis://localhost:6379/2",
                SQL_DSN: "postgres://veloera:veloera@localhost/veloera",
